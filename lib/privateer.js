...
module.exports = function privateer(exchange){
  ...
  if (typeof window !== 'undefined') {
    throw new Error('privateer noticed an unexpected global variable: `window`.  Any chance you might have exposed that in your userland code?  If `window` is exposed as a global, CCXT will get confused about its habitat (i.e. Node vs. browser) and not work properly.');
  }
