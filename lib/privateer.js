  ...
  var implementations = {
    ...
    createEachOrder: async function(inputs, exits) {
      ...
      for (let order of inputs.orders) {
        ...
        let currencies = order.operation.split(/[\»\>]+/).map((currency)=>currency.toUpperCase());
    ...
    getActiveOrders: async function(inputs, exits) {
      ...
      // [ { info:
      //      { Uuid: null,
      //        OrderUuid: '0da4b34e-bb89-4d57-a749-c650b55e02b0',
      //        Exchange: 'BTC-ETC',
      //        OrderType: 'LIMIT_BUY',
      //        Quantity: 0.26495956,
      //        QuantityRemaining: 0.26495956,
      //        Limit: 0.00192001,
      //        CommissionPaid: 0,
      //        Price: 0,
      //        PricePerUnit: null,
      //        Opened: '2017-11-09T05:16:11.31',
      //        Closed: null,
      ...
      // // TODO: format active orders to match this:
      // return exits.success([
      //   {
      //     id: '448383729',
      //     operation: 'btc»usd',
