  ...
  var implementations = {
    ...
    createEachOrder: async function(inputs, exits) {
      ...
      for (let order of inputs.orders) {
        ...
        // ^TODO: fix this  (don't need two, just one)
    ...
    getExchangeRates: async function(inputs, exits) {
      ...
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
      // ^^
      // TODO: allow this set of relevant currencies to be passed in
      // (to allow for filtering to speed this up)
      // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

      var markets = await ccxtExchange.fetchMarkets();
      var relevantMarkets = _.filter(markets, market => _.contains(currencies, market.base) && _.contains(currencies, market.quote));
