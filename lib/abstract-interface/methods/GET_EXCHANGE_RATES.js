...
possible operations based on the exchange\'s available currency markets.`
  ...
  exits: {
    ...
    success: {
      ...
      outputDescription: 'A mapping of current market exchange rates for selling 1 unit of one currency for some amount of another.',
      extendedDescription:
...
instead of thinking about 2-way "symbols", when using other methods, you can just think about currencies
like "ETH" and "sell" operations between currencies like "ETH»BTC" ("sell ETH, get BTC in return").
`,
      outputType: {},
      outputExample: {
        BTC: {
