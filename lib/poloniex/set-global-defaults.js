module.exports = {
  ...
  description: 'Save the specified default options (e.g. developer credentials) in a process-wide global variable for future, automatic (and easier) use of other methods in this package.',
  ...
  inputs: require('./private/INPUTS'),


  exits: {

    success: {
      description: 'Defaults have been cached for future use in other method calls.'
    },
